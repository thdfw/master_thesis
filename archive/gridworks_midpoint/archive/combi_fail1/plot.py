...
'''
def print_iteration(u_opt, x_opt, x_1, pb_type, t, combi):
    ...
    m_HP = functions.get_function("m_HP", u_opt_0, x_opt_0, 0, True, False, t, combi)
    m_buffer = functions.get_function("m_buffer", u_opt_0, x_opt_0, 0, True, False, t, combi)
    T_ret_HP = functions.get_function("T_ret_HP", u_opt_0, x_opt_0, 0, True, False, t, combi)
    T_sup_load = functions.get_function("T_sup_load", u_opt_0, x_opt_0, 0, True, False, t, combi)
