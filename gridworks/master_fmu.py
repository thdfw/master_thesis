...
list_S11, list_S21, list_S31 = list(res['T[1]']), list(res['T[5]']), list(res['T[9]'])
...
list_S11_pred, list_S21_pred, list_S31_pred = list(res_pred['T[1]']), list(res_pred['T[5]']), list(res_pred['T[9]'])
