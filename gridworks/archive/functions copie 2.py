...
# Compute all the functions at a point "a"
def get_all_f(a):
    return {id: f.subs(a) for id, f in functions.items()}

# Compute all the gradients at a point "a"
def get_all_grad_f(a):
    return {id: grad_f.subs(a) for id, grad_f in gradients.items()}
